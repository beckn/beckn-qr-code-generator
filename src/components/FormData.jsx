  ...
  return (
    <nav className="bg-blue-100 p-4 h-full">
      ...
      <div className="flex flex-col items-center">
        <div className='m-4'><img src="/beckn-logo.png" alt="Logo"/></div>
        <div><img src="/QRCode.gif" alt="Logo"/></div>
      </div>
    </nav>
  );
};
...
{qrCodeDataURL && !isLoading && (
  <div className="flex flex-col items-center mt-4">
    <QRCode value={`https://beckn-qr-code-generator.vercel.app/ui/${qrCodeDataURL}`} />
    <div className="mt-2">
      <Link
        to={`/ui/${qrCodeDataURL}`}
    ...
    <div className="mt-2">
      <a
        href={`https://beckn-qr-code-generator.vercel.app/ui/${qrCodeDataURL}`}
