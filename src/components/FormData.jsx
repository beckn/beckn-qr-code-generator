  ...
  return (
    <nav className="bg-blue-100 p-4 h-full">
      ...
      <div className="flex flex-col items-center">
        <div className='m-4'><img src="src\assets\beckn-logo.png" alt="Logo"/></div>
        <div><img src="src\assets\QR Code (1).gif" alt="Logo"/></div>
      </div>
    </nav>
  );
};
  ...
  const postData = async () => {
    ...
    await axios.post(url, data)
      .then(response => {
        ...
        axios.post("https://beckn-qr-gobg.vercel.app/qrGenerator", jsonData)
          .then(response => {
            console.log(response)
